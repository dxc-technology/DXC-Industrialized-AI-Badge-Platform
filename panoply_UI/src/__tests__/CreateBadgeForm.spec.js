...
describe('<CreateBadgeForm />', () => {
    ...
    describe('clicking the Create Badge button with non existing badge', () => {
        ...
        it('calls the API ', () => {
            ...
            expect(getCreateBadgeResponse).toHaveBeenCalledWith('Create User Story', 'This badge is to create data stories', 'https://panoply.dxc.com/admin/create-badge', 'True', 'Open Badge', 'akshay@gmail.com', 'akshay@gmail.com');
