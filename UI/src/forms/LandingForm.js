...
const LandingForm = (props) => {
  ...
  const mainListItems = (
    <div>
      <ListItem
        button
        data-testid="LandingForm_DashboardButton"
      ...
      <ListItem
        button
        data-testid="LandingForm_viewMyBackpackButton"
        onClick={handleMyBackpackButtonClick}
      >
        <ListItemIcon>
          <BootstrapTooltip title="My Backpack">
            <LocalMallIcon />
          </BootstrapTooltip>
        </ListItemIcon>
      ...
      <ListItem
        button
        data-testid="LandingForm_viewBadgeButton"
        onClick={handleViewbadgeButtonClick}
      >
        <ListItemIcon>
          <BootstrapTooltip title="Badges">
            <PeopleIcon />
          </BootstrapTooltip>
        </ListItemIcon>
  ...
  const secondaryListItems = (
    <div data-testid="adminSection">
      ...
      <ListItem
        button
        data-testid="LandingForm_createBadgeButton"
        onClick={handleCreateBadgeButtonClick}
      >
        <ListItemIcon>
          <BootstrapTooltip title="Create Badge">
            <AddToPhotosIcon />
          </BootstrapTooltip>
        </ListItemIcon>
      ...
      <ListItem
        button
        data-testid="LandingForm_viewAssertionsButton"
        onClick={handleViewAssertionsButtonClick}
      >
        <ListItemIcon>
          <BootstrapTooltip title="Assertions">
            <AssignmentIcon />
          </BootstrapTooltip>
        </ListItemIcon>
      ...
      <ListItem
        button
        data-testid="LandingForm_viewUsersButton"
        onClick={handleViewUsersButtonClick}
      >
        <ListItemIcon>
          <BootstrapTooltip title="User Management">
            <FaceIcon />
          </BootstrapTooltip>
        </ListItemIcon>
  ...
  const reviewerListItems = (
    <div data-testid="reviewerSection">
      ...
      <ListItem
        button
        data-testid="LandingForm_reviewerAssertionsButton"
        onClick={handleViewAssertionsButtonClick}
      >
        <ListItemIcon>
          <BootstrapTooltip title="Assertions">
      ...
      <div>
        <div className={classes.root}>
          ...
          >
            ...
            ) : userType == "5fc5567fcd831cc0c83774b8" ? (
              <List>{reviewerListItems}</List>
            ) : (
              <List></List>
            )}
          </Drawer>
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={8} lg={9}>
                  <Paper className={fixedHeightPaper}>
                    {clickedItem == "ViewUsersForm" ? (
                      <ViewUsersForm userID={userID} />
                    ) : clickedItem == "ViewAssertionsForm" ? (
                      <ViewAssertionsForm
                        email={email}
                        userType={userType}
                        userID={userID}
                      />
                    ) : clickedItem == "ViewBadgeForm" ? (
                      <ViewBadgeForm userType={userType} userID={userID} />
                    ) : clickedItem == "CreateBadgeForm" ? (
                      <CreateBadgeForm />
                    ) : clickedItem == "MyBackpackForm" ? (
                      <MyBackpackForm userID={userID} />
                    ) : clickedItem == "ViewProfileForm" ? (
                      <ViewProfileForm email={email} userID={userID} />
                    ) : (
                      <div>
                        <ReactPlayer
                          url={logo}
                          data-testid="DashboardForm_Logo"
                          playing
                          loop
                        />
        ...
        <input data-testid="landingID" value={email} hidden></input>
      </div>
    );
  }
};
