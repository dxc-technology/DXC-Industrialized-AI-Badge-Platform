...
def connect():
    if 'Panoply' in client.list_database_names():
...
def add_user_badge_mapping(user_id, badge_id, badge_status_id, work_link, admin_reviewer_id, assertion_id, public_link,
                           comments):
