...
def add_badge(badge_name, badge_description, utc_created_time, utc_modified_time, link, user_requestable, badge_type,
                ...
                if owner_reviewer_status == "Valid":
                    if user_evidence_status == evidence:
                        database.insert_new_badge(
                            badge_name, badge_description, utc_created_time, utc_modified_time, link, user_requestable,
...
def validate_badge_values(badge_name, badge_description, link, badge_type, user_requestable, owner, reviewer, icon,
    ...
    if badge_name == "":
        ...
        return "Empty icon"
    elif user_evidence_status == "Please choose the evidence Type":
        return "Please choose the evidence Type"
